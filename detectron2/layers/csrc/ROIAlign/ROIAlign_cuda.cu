...
at::Tensor ROIAlign_forward_cuda(
  ...
  dim3 grid(std::min(at::cuda::ATenCeilDiv((int64_t)output_size, (int64_t)512L), (int64_t)4096L));
  dim3 block(512);
...
at::Tensor ROIAlign_backward_cuda(
  ...
  dim3 grid(std::min(at::cuda::ATenCeilDiv((int64_t)grad.numel(), (int64_t)512L), (int64_t)4096L));
  dim3 block(512);
